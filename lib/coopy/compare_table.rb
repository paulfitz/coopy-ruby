module Coopy
  class CompareTable 
    ...
    def align_core2(align,a,b)
      ...
      begin
        ...
        while(_g < top) 
          ...
          fixed = Array.new()
          _it = ::Rb::RubyIterator.new(pending.keys(),nil)
          while( _it.has_next() ) do j = _it._next()
    ...
    def align_columns(align,a,b)
        ...
        while(_g < slop) 
          ...
          begin
            ...
            while(_g1 < slop) 
              ...
              _it = ::Rb::RubyIterator.new(ma.keys(),nil)
      ...
      _it2 = ::Rb::RubyIterator.new(ma_best.keys(),nil)
      while( _it2.has_next() ) do key = _it2._next()
