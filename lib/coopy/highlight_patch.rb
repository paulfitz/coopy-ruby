module Coopy
  class HighlightPatch 
    ...
    protected :header_pre
    
    attr_accessor :header_post
    protected :header_post
    
    attr_accessor :header_rename
    protected :header_rename
    
    attr_accessor :header_move
    protected :header_move
    ...
    protected :payload_col
    
    attr_accessor :payload_top
    protected :payload_top
    ...
    def finish_rows()
      ...
      begin
        ...
        while(_g < _g1.length) 
          ...
          if(!mod.rem) 
            if(mod.add) 
              _it = lambda{|_this_| _this = @headerPost
              $r2 = ::Rb::RubyIterator.new(_this.keys(),_this)}.call(self)
              while( _it.has_next() ) do c = _it._next()
              ...
              if(mod.update) 
                ...
                _it3 = lambda{|_this_| _this = @headerPre
                $r4 = ::Rb::RubyIterator.new(_this.keys(),_this)}.call(self)
                while( _it3.has_next() ) do c = _it3._next()
