module Coopy
  class DiffRender 
    ...
    def complete_html()
      @text_to_insert.splice(0,0,"<html>\n<meta charset='utf-8'>\n<head>\n<style TYPE='text/css'>\n")
      begin
        x = self.sample_css()
        @text_to_insert.splice(1,0,x)
      end
      @text_to_insert.splice(2,0,"</style>\n</head>\n<body>\n<div class='highlighter'>\n")
